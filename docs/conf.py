...
project = u'Yubico Client'
copyright = u'2013-2019, Tomaz Muraus'
...
version_str = '.'.join([str(p) for p in __version__])
version = version_str
release = version_str
...
man_pages = [
    ('index', 'yubicoclient', u'Yubico Client Documentation',
     [u'Tomaz Muraus'], 1)
]
